let phrases = [
  ...
  {
    text: "arrange books on the shelf by color",
    image: "https://code.s3.yandex.net/web-code/procrastinate/5.png",
  },
  {
    text: "read about salaries in San Francisco",
    image: "https://code.s3.yandex.net/web-code/procrastinate/6.png",
  },
  {
    text: "read the news and be horrified in the comments",
    image: "https://code.s3.yandex.net/web-code/procrastinate/7.png",
  },
  {
    text: "get into the stream of sad songs and remember all the mistakes of youth",
    image: "https://code.s3.yandex.net/web-code/procrastinate/8.png",
  },
  {
    text: "watch the trailer of the series and at the same time the first season",
    image: "https://code.s3.yandex.net/web-code/procrastinate/9.png",
  },
  {
    text: "check unread in Telegram channels",
